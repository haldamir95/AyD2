let lineReader,fetchQuery,Server,routerclient;_1bc‍.x([["clientServer",()=>clientServer]]);_1bc‍.w("../../line-reader",[["lineReader",["lineReader"],function(v){lineReader=v}]]);_1bc‍.w("../../request-manager",[["fetchQuery",["fetchQuery"],function(v){fetchQuery=v}]]);_1bc‍.w("../server",[["Server",["Server"],function(v){Server=v}]]);_1bc‍.w("../../routers/client-router",[["routerV1",["routerclient"],function(v){routerclient=v}]]);
...
class ClientServer extends Server {
  ...
  async start () {
    _1bc‍.g.console.log(this.header)
    await this.showMenu()
  ...
  async showMenu () {
    _1bc‍.g.console.log(this.divider)
    console.log(0, 'Terminar orden')
    Object.keys(this.Options).forEach((el, idx) => _1bc‍.g.console.log(idx + 1, this.Options[el]))
    _1bc‍.g.console.log(this.divider)
  }
  ...
  printOrder () {
    _1bc‍.g.console.log(this.oHeader)
    _1bc‍.g.console.log(this.Data)
    _1bc‍.g.console.log(this.oFooter)
  }
  ...
  async enviarTransaccion() {
    _1bc‍.g.console.log("ENVIAR TRANSACCION", this.Data)
      ...
      case "1":
        ...
        amqp.connect('amqp://3.21.165.119:5672', function(error0, connection) {
          ...
          connection.createChannel(function(error1, channel) {
              ...
              _1bc‍.g.console.log(" [x] Sent '%s'", msg);
          });
          setTimeout(function() {
              connection.close();
              process.exit(0)
